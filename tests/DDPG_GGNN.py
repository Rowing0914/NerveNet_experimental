...
class DDPG:
    def __init__(self, ggnn, critic, adjacency_matrix, num_node_feature, num_action, random_process, params):
        self.params = params
        self.num_action = num_action
        self.eval_flg = False
        self.index_timestep = 0
        self.actor = ggnn(adjacency_matrix, num_node_feature)
...
agent = DDPG(GGNN, Critic, adjacency_matrix, num_node_features, env.action_space.shape[0], random_process, params)
