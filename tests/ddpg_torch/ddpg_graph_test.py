...
import tests.ddpg_torch.utils as utils
import tests.ddpg_torch.OurDDPG as OurDDPG
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--env_name", default="CentipedeFour-v1")  # OpenAI gym environment name
    ...
    env = Monitor(env, directory="../logs/video/DDPG-torch-{}".format(args.env_name), force=True)
    ...
    # node_info = parse_mujoco_graph(task_name=args.env_name)
    ...
    # policy = OurDDPG.GraphDDPG(state_dim, action_dim, max_action, graph_operator)
