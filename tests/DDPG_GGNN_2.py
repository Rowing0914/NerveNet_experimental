...
class DDPG:
    def __init__(self, ggnn, critic, node_info, num_node_feature, num_action, random_process, params):
        self.params = params
        self.num_action = num_action
        self.eval_flg = False
        self.index_timestep = 0
        self.actor = ggnn(state_dim=num_node_feature, node_info=node_info)
...
agent = DDPG(GGNN, Critic, node_info, num_node_features, env.action_space.shape[0], random_process, params)
        ...
        for i in itertools.count():
            ...
            for t_train in range(10):
                ...
                for s, a, r, ns, d in zip(states, actions, rewards, next_states, dones):
                    ...
                    loss = agent.update(s[np.newaxis, ...], a[np.newaxis, ...], r[np.newaxis, ...], ns[np.newaxis, ...], d[np.newaxis, ...])
