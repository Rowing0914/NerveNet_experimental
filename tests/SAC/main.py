...
from tests.SAC.src.replay_memory import ReplayMemory
...
parser.add_argument('--policy', default="Gaussian", help='algorithm to use: Gaussian | Deterministic')
...
parser.add_argument('--automatic_entropy_tuning', type=bool, default=False, metavar='G', help='Temperature parameter α automaically adjusted.')
        ...
        if len(memory) > args.batch_size:
            ...
            for i in range(args.updates_per_step):
                ...
                critic_1_loss, critic_2_loss, policy_loss, ent_loss, alpha = agent.update_parameters(memory,
                                                                                                     args.batch_size,
                                                                                                     updates)
                # print(critic_1_loss, critic_2_loss, policy_loss)
